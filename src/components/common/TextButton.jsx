...
function TextButton({ children, className }) {
  return (
    <div
      className={`relative text-white px-[2rem] py-[0.66rem] text-[12px] lg:text-[14px] lg:px-[3rem] lg:py-[1rem] rounded-[0.66rem] lg:rounded-[1rem] chroma-button ${className}`}
      style={{
    ...
    >
      ...
      >
        ...
        <img
          ...
          src="/assets/images/Button-Decoration.png"
          alt=""
        />
      </div>
